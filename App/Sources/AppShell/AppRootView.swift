...
public struct AppRootView: View {
  ...
  public var body: some View {
    Group {
      ...
      case "composer":
        ComposerSurfaces.composerScreen(theme: launch.theme ?? activePreference)
      case "thread":
        PostThreadSurfaces.threadScreen(theme: launch.theme ?? activePreference)
      case "starterpacks":
        StarterPacksSurfaces.starterPackScreen(theme: launch.theme ?? activePreference)
      case "onboarding":
        OnboardingSurfaces.wizardScreen(theme: launch.theme ?? activePreference)
      case "settings":
        SettingsSurfaces.settingsScreen(theme: launch.theme ?? activePreference)
